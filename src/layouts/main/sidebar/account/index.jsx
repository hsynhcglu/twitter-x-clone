    ...
    return (
        <div className="mt-auto">
            <Popover className="relative">
                <Popover.Button 
                className="my-3 p-3 rounded-full hover:bg-[#eff3f41a] w-full flex items-center text-left outline-none">
				...
				>
                    <Popover.Panel className="absolute bottom-[88px] py-3 w-[300px] left-1/2 -translate-x-1/2 bg-black shadow-box rounded-2xl overflow-hidden">
                        {({ close }) => (
                            <More close={close} />
                        )}
                    </Popover.Panel>
